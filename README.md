...
<p align="center">
  ...
  <a href="./LICENSE"><img alt="license" src="https://img.shields.io/badge/license-Source%20License%20(No%20AI%20Training)-black" /></a>
...
[`skills/repo-shield/SKILL.md`](skills/repo-shield/SKILL.md) — instructions plus
...
- [Open an issue](https://github.com/EnzoVezzaro/repo-shield/issues) for a bug
  or a suggestion
- Read [DESIGN.md](DESIGN.md) before changing UI or tokens
